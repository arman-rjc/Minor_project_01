...
B = st.sidebar.number_input('Steel Plate thickness/web thickness, b (mm)',value = 10,step=0.01,format="%.2f")
H = st.sidebar.number_input('Height of steel plate, d (mm)',value = 250,step=0.01,format="%.2f")
